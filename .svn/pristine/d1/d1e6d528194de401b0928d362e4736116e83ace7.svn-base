...
public class FolderSelectedActivity extends BaseActivity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.tv_folderselected_confirm:
			Toast.makeText(context, "你选择了文件夹：" + currentFile.getPath(), Toast.LENGTH_LONG).show();
		...
		case R.id.tv_folderselected_new:
			AlertDialog.Builder dialog = new Builder(FolderSelectedActivity.this);
	...
	class MyAdapter extends BasicAdapter {
		...
		public View getView(int position, View view, ViewGroup parent) {
			...
			TextView tv = null;
			if (view == null) {
				view = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.item_folderselected_list, parent, false);
