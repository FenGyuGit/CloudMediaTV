...
public class AppApiImpl implements AppApi {
	 ...
	 * @return
	 * 
	 *         Created by Administrator Created on 2015-7-30 下午4:31:58
	 */
	 ...
	 * @param str
	 * 
	 *            Created by Administrator Created on 2015-7-29 上午8:54:03
	 */
				...
				public void callback(JSONObject object) {
					if (null != object) {
						...
						if (apkInfo != null)
							...
							listener.onFailure(context.getResources().getString(R.string.no_update));
					} else {
