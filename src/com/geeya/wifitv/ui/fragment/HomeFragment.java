...
import com.geeya.wifitv.utils.PasswordDialog;
import com.geeya.wifitv.utils.PasswordDialog.OnCustomDialogListener;
import com.geeya.wifitv.widget.NestListView;
...
public class HomeFragment extends BaseFragment implements IHomeFrag {
	...
	private NestListView lvWifiList;
	...
	//private RelativeLayout rlAddWifiTitleBar;// 手动添加wifi标题栏
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// dialogContext = this.getActivity().getBaseContext();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		initWifiList();
		setListener();
		homeReceiver = new HomeReceiver(this, context);
	...
	private void initViewId() {
		svController = (ScrollView)rootView.findViewById(R.id.sv_controller);
		tvConnectivityState = (TextView) rootView.findViewById(R.id.tv_fragment_home_wifi_state);
		lvWifiList = (NestListView) rootView.findViewById(R.id.lv_wifilist);
		...
		//rlAddWifiTitleBar = (RelativeLayout) rootView.findViewById(R.id.rl_fragment_wifi_list_add_wifi);
...
//		rlAddWifiTitleBar.setOnClickListener(new OnClickListener() {
//
//			@Override
//			public void onClick(View v) {
//				// TODO Auto-generated method stub
//				Intent intent = new Intent(context, AddWlan.class);
...
//		});
	...
	public void initWifiList() {
		lvWifiList.setParentScrollView(svController);
	...
	public void updateAdapter(java.util.List<ScanResult> list) {
		if (list != null && list.size() > 0) {
			if (null != adapter) {
				...
				adapter = new HomeListViewAda(context, list);
	...
	public void playOpenAnimation() {
		// TODO Auto-generated method stub
		TranslateAnimation animation = new TranslateAnimation(DisplayUtils.dip2px(context, -35), 0, 0, 0);
	...
	public void expandTitleBar() {
		...
		ivShrinkWifiBar.setImageResource(R.drawable.fragment_home_wifilist_shrink);
	}

	@Override
	public void shrinkTitleBar() {
		llWifiBar.setVisibility(View.GONE);
		ivShrinkWifiBar.setImageResource(R.drawable.fragment_home_wifilist_expand);
	}
	...
	public void showDialog(final String SSID, final int cipherType) {
		PasswordDialog dialog = new PasswordDialog(getActivity(), new OnCustomDialogListener() {
	...
	private void reDraw(int size){
		if (size < 4) {		
			...
			context.getResources().getValue(R.dimen.home_wifilist_item_height, value, true);
			int height = DisplayUtils.dip2px(context, TypedValue.complexToFloat(value.data));
			LinearLayout.LayoutParams lv_layout = (LinearLayout.LayoutParams) lvWifiList.getLayoutParams();
