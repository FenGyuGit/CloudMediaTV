...
public class HelpDetailActivity extends Activity{
	...
	private void addView(){
		...
		for(int i = 0 ; i < length; i ++){
			LinearLayout.LayoutParams questionParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
			...
			LinearLayout.LayoutParams answerParams = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
