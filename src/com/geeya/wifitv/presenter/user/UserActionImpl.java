...
public class UserActionImpl implements UserAction {
	...
	public void userRegist() {
		// TODO Auto-generated method stub
		final String registAccount = iRegister.getEtAccount();
		String registerName = iRegister.getEtName();
		final String registPassWord = iRegister.getEtPassword();
		...
		userApi.userRegist(registAccount, registerName, registPassWord, registRepeatPassword, new UserActionCallbackListener<Void>() {
			@Override
			public void onSuccess(Void data) {
				userApi.setUserLoginInfo(registAccount, registPassWord);
				iRegister.kill();
			}
