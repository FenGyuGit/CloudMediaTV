...
public class HomeListViewAda extends BasicAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		int recommendationWifi = wifiList.SSID.indexOf("ai");
		...
		if(Math.abs(wifiList.level) > 100){
			if(cipherType.equals(context.getResources().getString(R.string.home_listview_ada_nocipher)))
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_0_passwd));
			else
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_0_nopasswd));
		}else if (Math.abs(wifiList.level) > 85) {
			if(cipherType.equals(context.getResources().getString(R.string.home_listview_ada_nocipher)))
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_1_nopasswd));
			else
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_1_passwd));
		}else if (Math.abs(wifiList.level) > 75) {
			if(cipherType.equals(context.getResources().getString(R.string.home_listview_ada_nocipher)))
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_2_nopasswd));
			else
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_2_passwd));
		}else if (Math.abs(wifiList.level) > 65) {
			if(cipherType.equals(context.getResources().getString(R.string.home_listview_ada_nocipher)))
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_3_nopasswd));
			else
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_3_passwd));
		}else{
			if(cipherType.equals(context.getResources().getString(R.string.home_listview_ada_nocipher)))
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_4_nopasswd));
			else
				holder.icon.setImageDrawable(context.getResources().getDrawable(R.drawable.home_list_db_4_passwd));
		}		
		return view;
	}
